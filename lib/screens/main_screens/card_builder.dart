...
import 'package:natbet/widgets/alert_close_dialog.dart';
...
class _CardBuiderState extends State<CardBuider> {
                                                                      ...
                                                                      ? await showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return InputCoinForm(
                                                                              ...
                                                                              currentPlayerSnapshot: userBettingSnapshot.data,
                                                                              roomDocId: widget.roomDocId,
                                                                              button: 0,
                                                                              currentUserCoins: currentUserSnapshot.data['coins'],
                                                                            );
                                                                          })
                                                                      : null
                                                                },
                                                                child: Container(
                                                                    child: Text("${gameData['leftBudget']}",
                                                                        style: TextStyle(
                                                                          color:
                                                                              Colors.white,
                                                                        ))),
  ...
  _showCloseBetDialog(
    ...
    CloseDialogWidget alert = CloseDialogWidget(
      title: "Close",
  ...
  _showRefundDialog(BuildContext context, String roomDocId, String gameDocId) {
    VoidCallback continueCallBack = () async => {
          ApiManagement().refundBet(roomDocId, gameDocId),
        };
    BlurryDialogWidget alert = BlurryDialogWidget(
        title: "Refund",
        content: "Refund bet?",
